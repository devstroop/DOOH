...
namespace DOOH.Client.Pages.Customer.Campaigns
{
    public partial class Campaigns
    {
        ...
        protected async Task AddButtonClick(MouseEventArgs args)
        {
                ...
                if (result != null && result is string)
                {
                    ...
                    if (created != null)
                    {
                        NavigationManager.NavigateTo($"customer/campaigns/editor{created.CampaignId}");
                    }
                    else
                    {
        ...
        {
            NavigationManager.NavigateTo($"customer/campaigns/editor/{campaign.CampaignId}");
        }
