...
{
    public partial class AddAdboardNetwork
    {
        [Inject]
        ...
        {
            adboardNetwork = new DOOH.Server.Models.DOOHDB.AdboardNetwork();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await DOOHDBService.CreateAdboardNetwork(adboardNetwork);
